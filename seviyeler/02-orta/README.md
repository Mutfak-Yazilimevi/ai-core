...
| Kavram | Kategori |
|--------|----------|
| [Ajan Döngüsü (Agent Loop)](agent-loop/agent-loop.md) | 1. Temeller ve Çalışma Modeli |
| [Ajan Boru Hattı (Agentic Pipeline)](agentic-pipeline/agentic-pipeline.md) | 6. İş Akışı ve Yürütme |
| [Parçalama (Chunking)](chunking/chunking.md) | 4. Bellek ve Bilgi Yönetimi |
| [Bağlam Penceresi (Context Window)](context-window/context-window.md) | 3. Bağlam ve İstem Mühendisliği |
| [Gömme / Vektör Veritabanı (Embeddings / Vector Database)](embeddings-vector-db/embeddings-vector-db.md) | 4. Bellek ve Bilgi Yönetimi |
| [Fonksiyon Çağırma (Function Calling)](function-calling/function-calling.md) | 5. Araç Kullanımı ve Entegrasyon |
| [Devir İşlemleri (Handoffs)](handoffs/handoffs.md) | 6. İş Akışı ve Yürütme |
| [Döngüde İnsan (HITL (Human-in-the-Loop))](hitl/hitl.md) | 9. Güvenlik, Hizalama ve Denetim |
| [Bağlam İçi Öğrenme (Few/Zero-shot) (In-context Learning)](in-context-learning/in-context-learning.md) | 3. Bağlam ve İstem Mühendisliği |
